...
for index_2 = 2 : num_point
    ...
    if top_index == 1 && rgt_index == 1 && sum_index == 2
        if del_x > 0
            if cell_4_idx == 0
                final_list = [final_list; cell_4];
            end
    ...
    if top_index == 1 && lft_index == 1 && sum_index == 2
        if del_x > 0
            if cell_7_idx == 0
                final_list = [final_list; cell_7];
            end
    ...
    if btm_index == 1 && rgt_index == 1 && sum_index == 2
        if del_x > 0
            if cell_4_idx == 0
                final_list = [final_list; cell_4];
            end
    ...
    if btm_index == 1 && lft_index == 1 && sum_index == 2
        if del_x > 0
            if cell_2_idx == 0
                final_list = [final_list; cell_2];
            end
