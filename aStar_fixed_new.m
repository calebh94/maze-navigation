function opt_route = aStar_fixed_new(input_map, state, goal, map_struct)
    ...
    for i = 1 : 8
        ...
        if (in_open == 0) && (in_close == 0)
            ...
            if map_status == 0
                ...
                if top_status == 0 && lft_status == 0
                    continue
                elseif top_status == 0 && rgt_status == 0
                    continue
                elseif btm_status == 0 && lft_status == 0
                    continue
                elseif btm_status == 0 && rgt_status == 0
                    continue
                elseif top_status == 0 && btm_status == 0
                    continue
                elseif lft_status == 0 && rgt_status == 0
                    continue
                else
